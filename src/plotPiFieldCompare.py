...
fig = plt.figure(num=None, figsize=mm2inch(110.0, 51.0), dpi=300)
...
# plot Fourier eFlux
ax1 = plt.subplot2grid((3, 15), (0, 0), rowspan=1, colspan=14) #, sharex=ax1)
ax1.set_xticks([])
...
# plot Gauss eFlux
ax2 = plt.subplot2grid((3, 15), (1, 0), rowspan=1, colspan=14) #, sharex=ax1)
ax2.set_xticks([])
...
# plot box eFlux
ax3 = plt.subplot2grid((3, 15), (2, 0), rowspan=1, colspan=14) #, sharex=ax1)
...
ax4 = plt.subplot2grid((3, 15), (0, 14), rowspan=3, colspan=1) #, sharex=ax1)
cb4 = plt.colorbar(im1, cax=ax4, orientation='vertical')
cb4.set_ticks([-0.01, 0.0, +0.01])
cb4.set_label(r"$\Pi$ in $U^{3}_{c} R^2$")
