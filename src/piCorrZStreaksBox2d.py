...
print('Compute eFlux (Box) and 1d axial correlations with streaks for', len(iFiles), 'snapshot(s):', iFiles[0], 'to', iFiles[-1])
...
fnam = 'piCorrZStreaksBox2d_pipe0002_'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
f = open(fnam, 'w')
...
ax1.text(-1000.0, 0.75, "Box", ha="center", va="center")
