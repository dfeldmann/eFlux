...
ax1.plot(th, cpithG, color=Vermillion,  linestyle='-',  marker='o', markevery=[201, 214], zorder=9, label=r"$\alpha = \Pi$ (Gauss)")
ax1.plot(th, cpithB, color=Blue,        linestyle='-',  marker='s', markevery=[199, 210], zorder=8, label=r"$\alpha = \Pi$ (Box)")
...
ax2.plot(z, cpizG, color=Vermillion,  linestyle='-', marker='o', markevery=[1213], zorder=9, label=r"$\alpha = \Pi$ (Gauss)")
ax2.plot(z, cpizB, color=Blue,        linestyle='-', marker='s', markevery=[1197], zorder=8, label=r"$\alpha = \Pi$ (Box)")
