...
#           based on a box filter kernel. Read radial and axial velocity
...
print('Plot instantaneous energy flux on top of inward (Q3) and outward (Q1) interactions in a wall-parallel plane for a box filter')
...
t1 = ax1.text(1750.0, 550.0, r"Box", ha="right", va="top", rotation=0, bbox=filterBox)
...
if plot != 2:
 ...
 fnam = str.replace(fnam, 'piFieldBox2d', 'plotPiQ3Q1Box')
 plt.savefig(fnam)
