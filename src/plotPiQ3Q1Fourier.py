...
# Usage:    python plotPiQ3Q1Fourier.py 
...
print('Plot instantaneous energy flux on top of inward (Q3) and outward (Q1) interactions in a wall-parallel plane for a Fourier filter')
...
if plot != 2:
 ...
 fnam = str.replace(fnam, 'piFieldFourier2d', 'plotPiQ3Q1Fourier')
 plt.savefig(fnam)
