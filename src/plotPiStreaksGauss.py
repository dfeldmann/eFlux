...
#           based on a Gauss filter kernel. Read axial velocity data from the
...
#           figure file.
# Usage:    python plotPiStreaksGauss.py 
...
print('Plot instantaneous energy flux on top of streaks in a wall-parallel plane for a Gauss filter')
...
if plot != 2:
 ...
 fnam = str.replace(fnam, 'piFieldGauss2d', 'plotPiStreaksGauss')
 plt.savefig(fnam)
