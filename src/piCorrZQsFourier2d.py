...
#           figure file.
# Usage:    python piCorrZQsFourier2d.py
...
print('Compute eFlux (Fourier) and 1d axial correlations with Q events for', len(iFiles), 'snapshot(s):', iFiles[0], 'to', iFiles[-1])
...
fnam = 'piCorrZQsFourier2d_pipe0002_'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
f = open(fnam, 'w')
...
ax1.text(-400.0, 0.75, "Fourier", ha="center", va="center")
