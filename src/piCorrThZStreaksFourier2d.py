...
# Usage:    python piCorrThZStreaksFourier2d.py
# Authors:  Daniel Feldmann, Mohammad Umair, Jan Chen
# Date:     28th March 2019
# Modified: 29th December 2019
...
acUzF       = np.zeros((nth, nz))  # initialise auto-correlation for u'_z Fourier filtered
...
fnam = 'piCorrThZStreaksFourier2d_pipe0002_'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
f = open(fnam, 'w')
...
ig[4].axis("off")
ig[4].text(0.0, 0.0, r"Fourier", ha="center", va="center", rotation=0, bbox=filterBox)
