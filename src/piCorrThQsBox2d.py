...
#           file.
# Usage:    python piCorrThQsBox2d.py
...
print('Compute eFlux (Box) and 1d azimuthal correlations with Q events for', len(iFiles), 'snapshot(s):', iFiles[0], 'to', iFiles[-1])
...
fnam = 'piCorrThQsBox2d_pipe0002_'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
f = open(fnam, 'w')
