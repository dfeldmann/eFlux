...
print('Plot 1d cross-correlations between energy flux and Q2 events based on different kernels.')
...
cthF = np.loadtxt(fnam)[:, 7] # 8th column: Cross-correlation Q2 with Pi
...
cthG = np.loadtxt(fnam)[:, 7] # 8th column: Cross-correlation Q2 with Pi
...
cthB = np.loadtxt(fnam)[:, 7] # 8th column: Cross-correlation Q2 with Pi
...
czF = np.loadtxt(fnam)[:, 7] # 8th column: Cross-correlation Q2 with Pi
...
czG np.loadtxt(fnam)[:, 7] # 8th column: Cross-correlation Q2 with Pi
...
czB np.loadtxt(fnam)[:, 7] # 8th column: Cross-correlation Q2 with Pi
...
if plot == 1:
 ...
 fnam = str.replace(fnam, 'piCorrZQsBox2d', 'plotPiCorr1dQ2Compare')
 plt.savefig(fnam)
