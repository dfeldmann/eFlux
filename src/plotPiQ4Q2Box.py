...
print('Plot instantaneous energy flux on top of sweep (Q4) and ejection (Q2) events in a wall-parallel plane for a Box filter')
...
if plot != 2:
 ...
 fnam = str.replace(fnam, 'piFieldBox2d', 'plotPiQ4Q2Box')
 plt.savefig(fnam)
