...
print('Compute eFlux (Box) and 1d azimuthal correlations with streaks for', len(iFiles), 'snapshot(s):', iFiles[0], 'to', iFiles[-1])
...
ax1.text(-200.0, 0.75, "Box", ha="center", va="center")
