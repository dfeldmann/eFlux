...
#           plane for the energy flux (Pi) and Q4 events representing typical
#           sweep events of the near-wall cycle. Correlation maps are read from
#           several ascii files and plotted for three different filters
...
# Usage:    python plotPiCorr2d1dQ4Compare.py
...
print('Plot 1d and 2d cross-correlations between energy flux and Q4 (sweep) events based on different kernels.')
...
pqthF = np.loadtxt(fnam)[:, 9] # 10th column: Cross-correlation Q4 with Pi

# read 1d azimuthal cross-correlation with Q4 events for Gauss filtered eFlux from ascii file
fnam = 'piCorrThQsGauss2d_pipe0002_00570000to01675000nt0222.dat'
print('Reading 1d cross-correlation from', fnam)
pqthG = np.loadtxt(fnam)[:, 9] # 10th column: Cross-correlation Q4 with Pi

# read 1d azimuthal cross-correlation with Q4 events for box filtered eFlux from ascii file
fnam = 'piCorrThQsBox2d_pipe0002_00570000to01675000nt0222.dat'
print('Reading 1d cross-correlation from', fnam)
pqthB = np.loadtxt(fnam)[:, 9] # 10th column: Cross-correlation Q4 with Pi

# read 1d axial cross-correlation with Q4 events for Fourier filtered eFlux from ascii file
fnam = 'piCorrZQsFourier2d_pipe0002_00570000to01675000nt0222.dat'
print('Reading 1d cross-correlation from', fnam)
z1d  = np.loadtxt(fnam)[:, 0] #  1st column: Axial separation, only once
pqzF = np.loadtxt(fnam)[:, 9] # 10th column: Cross-correlation Q4 with Pi

# read 1d axial cross-correlation with Q4 events for Gauss filtered eFlux from ascii file
fnam = 'piCorrZQsGauss2d_pipe0002_00570000to01675000nt0222.dat'
print('Reading 1d cross-correlation from', fnam)
pqzG = np.loadtxt(fnam)[:, 9] # 10th column: Cross-correlation Q4 with Pi

# read 1d axial cross-correlation with Q4 events for box filtered eFlux from ascii file
fnam = 'piCorrZQsBox2d_pipe0002_00570000to01675000nt0222.dat'
print('Reading 1d cross-correlation from', fnam)
pqzB = np.loadtxt(fnam)[:, 9] # 10th column: Cross-correlation Q4 with Pi
...
# read 2d cross-correlation with Q4 events for Fourier filtered eFlux from ascii file
...
f  = np.loadtxt(fnam)[:, 10] # 11th column: Cross-correlation for Q4 and Pi

# read 2d cross-correlation with Q4 events for Gauss filtered eFlux from ascii file
...
print('Reading 2d cross-correlations from', fnam)
g  = np.loadtxt(fnam)[:, 10] # 11th column: Cross-correlation for Q4 and Pi

# read 2d cross-correlation with Q4 events for box filtered eFlux from ascii file
fnam = 'piCorrThZQsBox2d_pipe0002_01675000to01675000nt0001.dat'
fnam = 'piCorrThZQsBox2d_pipe0002_00570000to01675000nt0222.dat'
print('Reading 2d cross-correlations from', fnam)
b  = np.loadtxt(fnam)[:, 10] # 11th column: Cross-correlation for Q4 and Pi
...
ax4.set_xlabel(r"$C_{Q_{4}\Pi}$")
ax4.set_xlim(left=-0.33, right=0.14)
ax4.set_xticks([-0.20, 0.0])
...
if plot != 2:
 ...
 fnam = str.replace(fnam, 'piCorrThZQsBox2d', 'plotPiCorr2d1dQ4Compare')
 plt.savefig(fnam)
