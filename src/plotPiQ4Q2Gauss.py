...
#           pfd figure file.
# Usage:    python plotPiQ4Q2Gauss.py 
...
print('Plot instantaneous energy flux on top of sweep (Q4) and ejection (Q2) events in a wall-parallel plane for a Gauss filter')
...
if plot != 2:
 ...
 fnam = str.replace(fnam, 'piFieldGauss2d', 'plotPiQ4Q2Gauss')
 plt.savefig(fnam)
