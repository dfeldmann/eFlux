...
#           based on 2d Box space cut-off filter, subtract mean velocity profile,
...
f.write('# Inter-scale energy flux Pi^l based on a 2d Box space cut-off filter)\n')
...
if plot != 2:
 ...
 fig.tight_layout()
 fnam = 'piStatBox2d'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.pdf'
 plt.savefig(fnam)
