...
#           the Fourier filtered interscale energy flux in azimuthal direction.
...
#           of snapshots 
# ----------------------------------------------------------------------------------
# Usage:    python crosscoPiFourierQ2Q4.py 
...
nt = 0
acE15Q2  = np.zeros(nth) # initialized for the correlation coefficient
acE15Q4  = np.zeros(nth) # initialized for the correlation coefficient
...
fnam = 'crosscorreFluxFourierQ2Q4event1d'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
print('-------------------------------------------------------------------------')
print('Writing cross-correlation to file', fnam)
f = open(fnam, 'w')
f.write('# One-dimensional two-point auto-correlations in azimuthal (z) direction\n')
...
if plot != 2:
 ...
 fig.tight_layout()
 fnam = 'crosscorreFluxFourierQ2Q4event1d'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.pdf'
 plt.savefig(fnam)
