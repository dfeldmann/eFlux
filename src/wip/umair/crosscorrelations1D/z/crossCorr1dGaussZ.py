...
#           velocity (both filtered and unfiltered) and gauss filtered eflux, axial
#           vorticity and the Gauss filtered eflux in axial direction. 
...
#           of snapshots 
# ----------------------------------------------------------------------------------
# Usage:    python crossCorr1dGaussZ.py 
...
fnam = 'crossCorr1dGaussZ'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
print('-------------------------------------------------------------------------')
