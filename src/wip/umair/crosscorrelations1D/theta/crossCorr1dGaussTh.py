...
#           velocity (both filtered and unfiltered) and gauss filtered eflux, azimuthal
#           vorticity and the Gauss filtered eflux in azimuthal direction. 
...
#           of snapshots 
# ----------------------------------------------------------------------------------
# Usage:    python crossCorr1dGaussTh.py 
...
fnam = 'crossCorr1dGaussTh'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
print('-------------------------------------------------------------------------')
...
f.write('# For Uz, Uz(Gauss Filtered), eFlux and azimuthal vorticity component.\n')
