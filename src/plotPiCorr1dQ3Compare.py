...
print('Plot 1d cross-correlations between energy flux Q3 events based on different kernels.')
...
if plot == 1:
 ...
 fnam = str.replace(fnam, 'piCorrThQ3Q1Box2d', 'plotPiCorr1dQ3Compare')
 plt.savefig(fnam)
