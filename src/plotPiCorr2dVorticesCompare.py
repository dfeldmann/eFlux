...
# Usage:    python plotPiCorr2dVorticesCompare.py 
...
print('Plot 2d cross-correlations between energy flux and vortices based on different kernels.')
...
f  = np.loadtxt(fnam)[:, 8] # 9th column: Cross-correlation for omega_z and Pi
...
cb1.ax.set_ylabel(r"$C_{\omega_{z}\Pi^{\prime}}$")
...
if plot != 2:
 ...
 fnam = str.replace(fnam, 'piCorrThZStreaksBox2d', 'plotPiCorr2dVorticesCompare')
 plt.savefig(fnam)
