...
#           of snapshots 
# ----------------------------------------------------------------------------------
# Usage:    python autocorrFourierTh.py 
...
nt = 0
acUz   = np.zeros(nth) # initialized for the correlation coefficient
acUzF  = np.zeros(nth) # initialized for the correlation coefficient
acPi   = np.zeros(nth) # initialized for the correlation coefficient
acOmgZ = np.zeros(nth)
...
fnam = 'autoCorr1dFourierTh'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
print('-------------------------------------------------------------------------')
