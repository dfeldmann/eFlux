...
#           the Box filtered interscale energy flux in azimuthal direction.
...
#           of snapshots 
# ----------------------------------------------------------------------------------
# Usage:    python crosscoPiBoxQ2Q4.py 
...
fnam = 'crosscorreFluxBoxQ2Q4event1d'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
print('-------------------------------------------------------------------------')
...
if plot != 2:
 ...
 fig.tight_layout()
 fnam = 'crosscorreFluxBoxQ2Q4event1d'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.pdf'
 plt.savefig(fnam)
