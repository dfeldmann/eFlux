...
#           velocity (both filtered and unfiltered) and box filtered eflux, axial
#           vorticity and the Box filtered eflux in axial direction. 
...
#           of snapshots 
# ----------------------------------------------------------------------------------
# Usage:    python crossCorr1dBoxZ.py 
...
fnam = 'crossCorr1dBoxZ'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
print('-------------------------------------------------------------------------')
