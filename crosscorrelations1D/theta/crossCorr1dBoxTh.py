...
#           velocity (both filtered and unfiltered) and box filtered eflux, azimuthal
#           vorticity and the Box filtered eflux in azimuthal direction. 
...
fnam = 'crossCorr1dBoxTh'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.dat'
print('-------------------------------------------------------------------------')
...
f.write('# For Uz, Uz(Box Filtered), eFlux and azimuthal vorticity component.\n')
...
if plot != 2:
 ...
 fig.tight_layout()
 fnam = 'piCorr1dBoxZ'+'{:08d}'.format(iFirst)+'to'+'{:08d}'.format(iLast)+'nt'+'{:04d}'.format(nt)+'.pdf'
 plt.savefig(fnam)
