...
#--------------------------------------------------------------------------------
def box2d(u, lambdaTh, lambdaZ, r, th, z, option):
...
for iFile in iFiles:
    ...
    u_rF    = box2d(u_r,       lambdaTh, lambdaZ, r, th, z, 1)
    u_thF   = box2d(u_th,      lambdaTh, lambdaZ, r, th, z, 1)
    u_zF    = box2d(u_z,       lambdaTh, lambdaZ, r, th, z, 1)
